% Estimation of the localization accuracy by comparison of the experiment
% data with the reference
% Comparison data is collected separately for each cow and for each tag
...
%% Accuracy estimation for cows Fig. 12. a, b
...
%% Cumulative error graph Fig. 12. c, d
...
%% Example of preferable cow locations  Fig. 13. c
CowNo_i=1;
figure;
DrawHeatMap(DataFolder,CowPointFreqRef(CowNo_i,1:end-1));
set(gcf,'Position',[50 300 400 100]);

%% Total preferable locations in the barn Fig. 13. d
figure;
